...
def generate_launch_description():
    ...
    my_package_name = "turtle_tf_3d_ros2"
    pkg_box_bot_gazebo = get_package_share_directory(my_package_name)
    ...
    # Set the path to the WORLD model files. Is to find the models inside the models folder in turtle_tf_3d_ros2 package
    ...
    return LaunchDescription([
        DeclareLaunchArgument(
          'world',
          default_value=[os.path.join(pkg_box_bot_gazebo, 'worlds', 'turtle_empty.world'), ''],
